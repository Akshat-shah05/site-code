    ...
    return (
        ...
        <>
            ...
            <div className="self-description-photo">
                ...
                <h2 className="self-description-text"> I am a 17 y/o passionate developer exploring full-stack development, machine learning, web 3.0 and cybersecurity. I am currently pursuing my Bachelors of Computer Science at The University of Waterloo. Feel free to reach out to me either by email or instagram 🤠👋</h2>
            </div>
        </>
