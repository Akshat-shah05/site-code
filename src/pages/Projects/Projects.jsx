...
import { SiFastapi, SiStripe } from "react-icons/si";
import { SiOpenai, SiTypescript, SiNextdotjs } from "react-icons/si";
import { SiBootstrap, SiMysql, SiPrisma } from "react-icons/si";
              ...
              <Tilt>
                <div id="project-card-1" className="card-container">
                  <div id="content-container-1" className="content-card-container">
                    <div className="pimage"><img src={prodigy}></img></div>
                    <h2 className="project-card-title"> Prodigy </h2>
                    <h4>
                      {" "}A SaaS AI platform supporting image, video, code, and music generation, through OpenAI and
ReplicateAI, alongside a live AI chatbot to handle user inquiries{" "}
                    </h4>
                    <h4 className="source-code">
                      {" "}
                      <a href="https://github.com/Akshat-shah05/Prodigy" target="_blank">
                        {" "}
                        Source Code! &nbsp;&nbsp;&nbsp;{" "}
                      </a>
                    ...
                    <div className="technologies-used">
                      ...
                      <SiPrisma size={45} color="white"/>
                      <SiMysql size={45} color="orange" />
                      <SiTailwindcss size={45} color="#B4D7FF"/>
                      <SiOpenai size={45} color="white" />
                      <SiStripe size={45} color="6772E5"/>
                    </div>
                  </div>
                </div>
              </Tilt>
